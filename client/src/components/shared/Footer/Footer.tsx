                        ...
                        <Link className={styles.logo} to={HOME_PATH}>
                            ...
                            >
                                <g fill="none" fillRule="nonzero">
                                    ...
                                    <path
                                        fill="#fc5055"
                                        d="M10.582 16.91C6.955 16.91 4 14 4 10.427c0-3.573 2.954-6.484 6.58-6.484h.412V0h-.411C4.749 0 0 4.679 0 10.426 0 16.211 4.749 20.89 10.582 20.89h.411v-3.978h-.411z"
                                    ></path>
                                    <g>
                                        <path
                                            fill="#ffffff"
                                        ...
                                        <path
                                            fill="#ffffff"
                                            d="M171.7 3.942h-2.84l-5.46 5.453h-2.206V3.942H159.1v12.969h2.094v-5.416h2.206l5.384 5.416h2.842l-6.394-6.448zM140.74 16.91h2.32l-5.797-12.968h-2.393l-5.795 12.969h2.318l1.271-2.8h6.806l1.27 2.8zm-7.14-4.863l2.467-5.452 2.468 5.452h-4.936z"
                                        ></path>
                                        <path
                                            fill="#ffffff"
