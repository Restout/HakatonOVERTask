...
public class AttendanceController {
    ...
    public ResponseEntity<List<AttendanceOutList>> getAttendance(@PathVariable int scheduledId) {
    ...
    public ResponseEntity<List<AttendanceOutList>> createAttendance(@RequestBody List<AttendanceDAO> list, @PathVariable int scheduledId) {
